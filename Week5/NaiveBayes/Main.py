...
file1_sport = open('Sport/file1.txt', encoding='utf8').read().lower().split()
file2_sport = open('Sport/file2.txt', encoding='utf8').read().lower().split()
file3_sport = open('Sport/file3.txt', encoding='utf8').read().lower().split()
file4_sport = open('Sport/file4.txt', encoding='utf8').read().lower().split()
file5_sport = open('Sport/file5.txt', encoding='utf8').read().lower().split()
sports_array = np.concatenate((file1_sport, file2_sport, file3_sport, file4_sport, file5_sport), axis=None)
for i in sports_array:
    if len(i) < 4:
        continue
    sports.append(i)
file1_politics = open('News/file1.txt', encoding='utf8').read().lower().split()
file2_politics = open('News/file2.txt', encoding='utf8').read().lower().split()
file3_politics = open('News/file3.txt', encoding='utf8').read().lower().split()
file4_politics = open('News/file4.txt', encoding='utf8').read().lower().split()
file5_politics = open('News/file5.txt', encoding='utf8').read().lower().split()
politics_array = np.concatenate((file1_politics, file2_politics, file3_politics, file4_politics, file5_politics),
                                axis=None)
